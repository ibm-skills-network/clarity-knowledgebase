...
Author Workbench supports publishing to Skills Network Portals automatically. This includes our community initiative, [cognitiveclass.ai](https://cognitiveclass.ai). Publishing to other destinations such as [Coursera](https://www.coursera.org/partners/ibm-skills-network) or [edX.org](https://www.edx.org/school/ibm) will require you to be a partner with that destination. We recommend you only select Skills Network Portals as your platform unless otherwise instructed.

### Setting Dates

The start date and launch dates are the date you plan to start developing your course and expect to launch your course, respectively. This is important as it helps our team plan for the release of your course. It is also useful to help you stay on track with your course development.

Like any estimate, these dates do not have to be exact. Pick dates you think are reasonable and update them as needed.

If you are creating a course for more than 1 platform, you'll have to add start and end dates for the development of each of platforms since they are treated as separate courses.
